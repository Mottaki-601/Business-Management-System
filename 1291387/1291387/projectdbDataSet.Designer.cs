...
namespace _1291387.projectdbDataSetTableAdapters {
    ...
    public partial class citiesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[cities] WHERE (([id] = @Original_id) AND ((@IsNull_cityName = " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[cities] SET [cityName] = @cityName WHERE (([id] = @Original_id) AND" +
                " ((@IsNull_cityName = 1 AND [cityName] IS NULL) OR ([cityName] = @Original_cityN" +
                "ame)));\r\nSELECT id, cityName FROM cities WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_1291387.Properties.Settings.Default.projectdbCon;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, cityName FROM dbo.cities";
        ...
        public virtual int Fill(projectdbDataSet.citiesDataTable dataTable) {
        ...
        public virtual projectdbDataSet.citiesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            projectdbDataSet.citiesDataTable dataTable = new projectdbDataSet.citiesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projectdbDataSet.citiesDataTable dataTable) {
